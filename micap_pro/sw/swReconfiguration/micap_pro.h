...
*******************************************************************************************************
**/
#ifndef MICAP_PRO_H_ /* prevent circular inclusions */
#define MICAP_PRO_H_ /* by using protection macros */
...
void MiCAP_GetConfigurationCoordinates(long slice_row, long slice_col, u8 *bottom_ntop_p, int *clock_row_p, u32 *major_frame_address_p, u32 *word_offset_p);
int MiCAP_SetClbBits(XGpio * gpio_InstancePtr, XAxiDma * dma_InstancePtr, long clb_row, long clb_col, const u8 Resource[][2], const u8 Value[], long NumBits, u32* TxBufferPtr_wrFrame, u32* RxBufferPtr_wrFrame, u32* TxBufferPtr_rdFrame, u32* RxBufferPtr_rdFrame);
